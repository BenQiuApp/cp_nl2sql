...
import jieba
import re
from question_prepro import trans_question_acc
from utils import check_num_exactly_match
...
def treat_num_related_in_q(re_expre, question, cond_val):
	"""处理question中的数字映射问题"""
	try:
